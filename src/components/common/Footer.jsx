    ...
    <FooterWrapper>
        ...
        <div className="footer-content text-white d-grid container">
          ...
          <div className="footer-item">
            ...
            <ul className="footer-item-links">
              <li>
                <a href="https://www.playstation.com/en-vn/" className="text-white">
                  Gaming
                </a>
              </li>
              <li>
                <a href="https://store.playstation.com/en-sg/concept/10003386" className="text-white">
                  Product
                </a>
              </li>
              <li>
                <a href="https://www.facebook.com/profile.php?id=61560868992749" className="text-white">
                  Social Network
                </a>
              </li>
              <li>
                <a href="https://store.playstation.com/en-sg/pages/latest" className="text-white">
                  Community
                </a>
              </li>
            </ul>
          ...
          <div className="footer-item">
            ...
            <ul className="footer-item-links">
              ...
              <li>
                <a href="https://store.playstation.com/en-sg/product/EP0700-PPSA04609_00-ELDENRINGDLC0000" className="text-white">
                  Live Actions
                </a>
              </li>
              <li>
                <a href="https://www.playstation.com/en-sg/ps5/games/" className="text-white">
                  Our News
                </a>
              </li>
            </ul>
      ...
      <div className="footer-bottom">
        <div className="container d-flex flex-column text-center">
          ...
          Copyright &copy; {currentYear} 黎興 - All rights reserved.
          </p>
